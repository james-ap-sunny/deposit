-- Destination Database Initialization Script
-- This database will contain destination accounts for transfers
...
-- Insert sample destination accounts
INSERT INTO rb_acct (CLIENT_NO, BASE_ACCT_NO, ACCT_NAME, ACCT_CCY, ACCT_STATUS, ACCT_BRANCH) VALUES
('2108803575', '6230399991006371430', '赵六', 'CNY', 'A', '0504'),
('2108803576', '6230399991006371431', '孙七', 'CNY', 'A', '0504'),
('2108803577', '6230399991006371432', '周八', 'CNY', 'A', '0504');

-- Insert corresponding balances
INSERT INTO rb_acct_balance (INTERNAL_KEY, CLIENT_NO, TOTAL_AMOUNT) VALUES
(1, '2108803575', 5000.00),
(2, '2108803576', 12000.00),
(3, '2108803577', 20000.00);
...
('6230399991006371430', 'CNY', '2108803575', 'DailyTransferLimit', 50000.00, 0.01, CURDATE()),
('6230399991006371431', 'CNY', '2108803576', 'DailyTransferLimit', 50000.00, 0.01, CURDATE()),
('6230399991006371432', 'CNY', '2108803577', 'DailyTransferLimit', 50000.00, 0.01, CURDATE());